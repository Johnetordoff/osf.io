...
mock_responses = {
    ...
    'documents': [
        {
            'id': 'abcde/547a1215-efdb-36d2-93b2-e3ef8991264f',
            'title': 'Cloud Computing',
            'type': 'journal',
            'data': {'collections': [], 'key': '547a1215-efdb-36d2-93b2-e3ef8991264f',},
            'authors': [
                {'first_name': 'Shivaji P', 'last_name': 'Mirashe'},
                {'first_name': 'N V', 'last_name': 'Kalyankar'},
            ],
            'year': 2010,
        ...
        {
            'id': 'abcde/5e95a1a9-d789-3576-9943-35eee8e59ea9',
            'title': 'The Google file system',
            'type': 'generic',
            'data': {'collections': [], 'key': '5e95a1a9-d789-3576-9943-35eee8e59ea9',},
            'authors': [
                {'first_name': 'Sanjay', 'last_name': 'Ghemawat'},
                {'first_name': 'Howard', 'last_name': 'Gobioff'},
                {'first_name': 'Shun-Tak', 'last_name': 'Leung'},
            ],
            'year': 2003,
            'source': 'ACM SIGOPS Operating Systems Review',
            'identifiers': {'pmid': '191', 'issn': '01635980'},
        ...
        {
            'id': 'abcde/3480056e-fe4d-339b-afed-4312d03739a4',
            'title': 'Above the clouds: A Berkeley view of cloud computing',
            'type': 'journal',
            'data': {'collections': [], 'key': '3480056e-fe4d-339b-afed-4312d03739a4',},
            'authors': [
                {'first_name': 'M', 'last_name': 'Armbrust'},
                {'first_name': 'A', 'last_name': 'Fox'},
                {'first_name': 'R', 'last_name': 'Griffith'},
                {'first_name': 'AD', 'last_name': 'Joseph'},
                {'last_name': 'RH'},
            ],
            'year': 2009,
            'source': '  University of California, Berkeley, Tech. Rep. UCB ',
            'identifiers': {'pmid': '11242594', 'arxiv': '0521865719 9780521865715'},
            'keywords': [
                'cloud computing',
        ...
        {
            'id': 'abcde/e917dd51-8b94-3748-810b-cafa2accc18a',
            'title': 'Toward the next generation of recommender systems: A survey of the state-of-the-art and possible extensions',
            'type': 'generic',
            'data': {'collections': [], 'key': 'e917dd51-8b94-3748-810b-cafa2accc18a',},
            'authors': [
                {'first_name': 'Gediminas', 'last_name': 'Adomavicius'},
                {'first_name': 'Alexander', 'last_name': 'Tuzhilin'},
            ],
            'year': 2005,
            'source': 'IEEE Transactions on Knowledge and Data Engineering',
            'identifiers': {'issn': '10414347', 'pmid': '1423975', 'arxiv': '3'},
            'keywords': [
        ...
        {
            'id': 'abcde/8cd60008-888a-3212-966f-29d481b4b7b7',
            'title': 'An Introduction to Information Retrieval',
            'type': 'patent',
            'data': {'collections': [], 'key': '8cd60008-888a-3212-966f-29d481b4b7b7',},
            'authors': [
                {'first_name': 'Christopher D.', 'last_name': 'Manning'},
                {'first_name': 'Prabhakar', 'last_name': 'Raghavan'},
            ],
            'year': 2009,
            'source': 'Online',
            'identifiers': {
        ...
        {
            'id': 'abcde/de25a64f-493b-330e-a48c-4089bab938f5',
            'title': 'Learning of ontologies for the web: The analysis of existent approaches',
            'type': 'journal',
            'data': {'collections': [], 'key': 'de25a64f-493b-330e-a48c-4089bab938f5',},
            'authors': [{'first_name': 'Borys', 'last_name': 'Omelayenko'}],
            'year': 2001,
            'source': 'CEUR Workshop Proceedings',
            'identifiers': {'issn': '16130073'},
    ...
    'documents': [
        {
            ...
            'type': 'patent',
            'data': {
                'collections': ['ZYXWVUTSRQ'],
                'key': '8cd60008-888a-3212-966f-29d481b4b7b7',
            },
            'authors': [
                {'first_name': 'Christopher D.', 'last_name': 'Manning'},
                {'first_name': 'Prabhakar', 'last_name': 'Raghavan'},
...
mock_responses_with_filed_and_unfiled = {
    k: dumps(v) for k, v in mock_responses_with_filed_and_unfiled.items()
}
