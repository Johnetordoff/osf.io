...
class TestAuthViews(
    GoogleDriveAddonTestCase, OAuthAddonAuthViewsTestCaseMixin, OsfTestCase
):
    pass


class TestConfigViews(
    GoogleDriveAddonTestCase, OAuthAddonConfigViewsTestCaseMixin, OsfTestCase
):
    ...
    def setUp(self):
        ...
        self.mock_about = mock.patch.object(GoogleDriveClient, 'about')
