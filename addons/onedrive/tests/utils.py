...
raw_root_folder_response = [
    {
        'createdBy': {
            'application': {'displayName': 'local-cosdev', 'id': '44174239'},
            'user': {'displayName': 'Fitz Elliott', 'id': 'f4d50e400dfe7d4e'},
        },
...
raw_subfolder_response = [
    {
        ...
        'createdBy': {
            'application': {'displayName': 'local-thingapp', 'id': '994562945'},
            'user': {'displayName': 'Fitz Elliott', 'id': '992349'},
        },
        ...
        'image': {'height': 2456, 'width': 3477},
        'photo': {'takenDateTime': '2017-02-07T20:37:50.73Z'},
    }
]
