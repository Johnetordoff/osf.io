    ...
    u'items': [
        {
            ...
            u'description': u'<p>This is made using python</p>',
            u'links': [],
            u'title': u'New fileset',
            u'total_size': u'34.59 KB',
            ...
            u'version': 15,
            u'categories': [{u'id': 77, u'name': u'Applied Computer Science'}],
            u'published_date': u'22:13, Jan 16, 2014',
            u'description_nohtml': u'This is made using python',
            u'article_id': 902210,
            u'tags': [{u'id': 3564, u'name': u'code'}],
        }
    ],
}
...
def create_mock_figshare(project):
    ...
    figshare_mock.projects.return_value = [
        {u'owner': 506241, u'description': u'', u'id': 436, u'title': u'OSF Test'}
    ]
    figshare_mock.project.return_value = {
        'articles': [
            {
                u'status': u'Draft',
                u'files': [
            ...
            },
            {
                ...
                u'files': [
                    {
                        u'id': 1404749,
                        u'name': u'HW6.pdf',
                        u'thumb': u'http://figshare.com/read/private/1404749/250_1404749.png',
                ...
                u'defined_type': u'paper',
                u'version': 1,
                u'categories': [],
                u'published_date': u'09:25, Feb 24, 2014',
                u'description_nohtml': u'',
                u'article_id': 949657,
                u'tags': [],
            },
        ],
        u'description': u'',
        u'created': u'06/03/2014',
        u'id': 862,
        u'title': u'OSF Test',
    }
...
class FigshareAddonTestCase(OAuthAddonTestCaseMixin, AddonTestCase):
    ...
    client = None
    folder = {'path': 'fileset', 'name': 'Memes', 'id': '009001'}
