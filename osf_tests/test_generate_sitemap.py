...
class TestGenerateSitemap:
    ...
    def registration_active(
        self, user_admin_project_public, project_registration_public
    ):
    ...
    @pytest.fixture(autouse=True)
    def preprint_osf(
        self, project_preprint_osf, user_admin_project_public, provider_osf
    ):
    ...
    @pytest.fixture(autouse=True)
    def preprint_other(
        self, project_preprint_other, user_admin_project_public, provider_other
    ):
        return PreprintFactory(
    ...
    def all_included_links(
        self,
        user_admin_project_public,
        user_admin_project_private,
        project_registration_public,
        project_preprint_osf,
        project_preprint_other,
        registration_active,
        provider_other,
        preprint_osf,
        preprint_other,
    ...
    def test_unconfirmed_user_not_included(
        self, create_tmp_directory, user_unconfirmed
    ):
    ...
    def test_private_project_link_not_included(
        self, project_private, create_tmp_directory
    ):
    ...
    def test_embargoed_registration_link_not_included(
        self, registration_embargoed, create_tmp_directory
    ):
    ...
    def test_deleted_project_link_not_included(
        self, project_deleted, create_tmp_directory
    ):
