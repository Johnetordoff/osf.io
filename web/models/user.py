...
class Schema(models.Model):
    ...
    def to_atomic_schema(self):
        return {
            ...
            'version': self.version,
            'description': self.description,
            'blocks': [block.to_atomic_schema_block for block in self.blocks.all().order_by('index')]
        }
...
class Block(models.Model):
    ...
    help_text = models.CharField(max_length=5000, null=True, default='', blank=True, help_text='AKA help')
    display_text = models.CharField(max_length=5000, null=True, blank=True, default='', help_text='AKA title')
    example_text = models.CharField(max_length=5000, null=True, blank=True, default='', help_text='AKA example')
    block_type = models.CharField(choices=SCHEMABLOCKS, max_length=50000, null=True, blank=True)
    schema = models.ForeignKey('web.Schema', on_delete=models.SET_NULL, null=True, blank=True, related_name='blocks')
