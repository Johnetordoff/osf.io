...
class TestPreprintRequestActionList(PreprintRequestTestMixin):
    ...
    def test_nonmod_nonadmin_nonrequester_cannot_view(
    ...
    def test_mod_can_view(
        self, app, moderator, pre_request, post_request, auto_approved_pre_request
    ):
    ...
    def test_nonadmin_requester_can_view(
        self,
        app,
        requester,
        nonadmin_pre_request,
        nonadmin_post_request,
        nonadmin_none_request,
        nonadmin_auto_approved_pre_request,
    ):
        for request in [
            nonadmin_pre_request,
            nonadmin_post_request,
