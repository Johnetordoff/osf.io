...
class TestPreprintRequestDetail(PreprintRequestTestMixin):
    ...
    def test_admin_can_view_request(
    ...
    def test_moderator_view_permissions(
        self, app, moderator, pre_request, post_request, none_request
    ):
    ...
    def test_noncontrib_cannot_view_request(
