...
class TestInstitutionNodeList:
    ...
    def test_return_all_public_nodes(
        self, app, public_node, user_private_node, private_node, institution_node_url
    ):
    ...
    def test_registration_not_returned(self, app, public_node, institution_node_url):
...
class TestNodeListFiltering(NodesListFilteringMixin):
    ...
    def project(self, user, parent_project_one, institution):
        project = ProjectFactory(
            creator=user,
            title='Neighbor of {}'.format(parent_project_one._id),
            is_public=True,
        )
    ...
    def child_node_two(self, user, parent_project, institution):
        child_node_two = NodeFactory(
            parent=parent_project, creator=user, is_public=True
        )
