...
class TestPreprintProviderLicenses:
    ...
    @pytest.fixture(
        params=[
            '/{}preprint_providers/{}/licenses/',
            '/{}providers/preprints/{}/licenses/',
        ]
    )
    ...
    def test_preprint_provider_has_no_acceptable_licenses_and_no_default(
        self, app, provider, licenses, url
    ):
    ...
    def test_prerint_provider_has_acceptable_licenses_but_no_default(
    ...
    def test_preprint_provider_has_both_acceptable_and_default_licenses(
        self, app, provider, licenses, license_one, license_two, license_three, url
    ):
