...
class TestSloanStudyWaffling:
    ...
    def providers(self, user):
        ...
        PreprintProviderFactory(
            _id='burdixiv',
            domain='https://burdixiv.burds/',
            domain_redirect_enabled=True,
        ).save()
        PreprintProviderFactory(
            _id='shady',
            domain='https://staging2.osf.io/',
    ...
    def test_sloan_study_variable(self, app, user, preprint):
        ...
        assert (
            f' dwf_{SLOAN_COI_DISPLAY}=True; Domain=localhost; Path=/; samesite=None; Secure'
            in cookies
        )
        assert (
            f' dwf_{SLOAN_DATA_DISPLAY}=True; Domain=localhost; Path=/; samesite=None; Secure'
            in cookies
        )
        assert (
            f' dwf_{SLOAN_PREREG_DISPLAY}=True; Domain=localhost; Path=/; samesite=None; Secure'
            in cookies
        )
    ...
    def test_sloan_study_control(self, app, user, preprint):
        ...
        assert (
            f' dwf_{SLOAN_COI_DISPLAY}=False; Domain=localhost; Path=/; samesite=None; Secure'
            in cookies
        )
        assert (
            f' dwf_{SLOAN_DATA_DISPLAY}=False; Domain=localhost; Path=/; samesite=None; Secure'
            in cookies
        )
        assert (
            f' dwf_{SLOAN_PREREG_DISPLAY}=False; Domain=localhost; Path=/; samesite=None; Secure'
            in cookies
        )
    ...
    @pytest.mark.parametrize(
        'reffer_url, expected_provider_id',
        [
    ...
    @pytest.mark.parametrize('reffer_url', [DOMAIN, f'{DOMAIN}not-preprints/',])
    ...
    def test_provider_custom_domain(self, app, user, preprint):
        ...
        assert (
            f' dwf_{SLOAN_COI_DISPLAY}=True; Domain=.osf.io; Path=/; samesite=None; Secure'
            in cookies
        )
        assert (
            f' dwf_{SLOAN_COI_DISPLAY}_custom_domain=True; Domain=.burdixiv.burds; Path=/; samesite=None; Secure'
            in cookies
        )
    ...
    def test_user_override_cookie_false(self, app, user, preprint):
        ...
        assert (
            f' dwf_{SLOAN_COI_DISPLAY}=False; Domain=.osf.io; Path=/; samesite=None; Secure'
            in cookies
        )
