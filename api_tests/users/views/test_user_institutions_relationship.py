...
class TestUserInstititutionRelationship:
    ...
    def test_get(self, app, user, institution_one, institution_two, url):
        ...
        assert (
            user.absolute_api_v2_url + 'relationships/institutions/'
    ...
    def test_delete_one_not_existing(
        ...
        res = app.delete_json_api(
            url, {'data': [{'type': 'institutions', 'id': 'not_an_id'}]}, auth=user.auth
        )
    ...
    def test_institution_relationship_errors(
        ...
        res = app.delete_json_api(
            url,
            {'data': [{'type': 'wow', 'id': institution_one._id}]},
            auth=user.auth,
            expect_errors=True,
        )
        ...
        res = app.post_json_api(url, {}, expect_errors=True)
