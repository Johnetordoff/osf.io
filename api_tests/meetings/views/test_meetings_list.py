...
class TestMeetingsList:
    ...
    def test_meeting_list(self, res, meeting_one, meeting_two, meeting_three):
        ...
        assert set([meeting['id'] for meeting in res.json['data']]) == set(
            [meeting_two.endpoint, meeting_three.endpoint]
        )
...
class TestMeetingListFilter:
    ...
    def test_meeting_list_filter(
        ...
        meeting_three_submission_one,
        meeting_three_submission_two,
    ):
        # Filter on name
        res = app.get('{}{}'.format(filter_url, '[name]=Science'))
        assert len(res.json['data']) == 2
        assert set([meeting_one.endpoint, meeting_two.endpoint]) == set(
            [meeting['id'] for meeting in res.json['data']]
        )
        ...
        assert [meeting_three.endpoint, meeting_two.endpoint, meeting_one.endpoint] == [
            meeting['id'] for meeting in res.json['data']
        ]
        ...
        res = app.get('{}{}'.format(sort_url, '-name'))
        assert len(res.json['data']) == 3
        assert [meeting_one.endpoint, meeting_two.endpoint, meeting_three.endpoint] == [
            meeting['id'] for meeting in res.json['data']
        ]
        ...
        assert len(res.json['data']) == 3
        assert [meeting_two.endpoint, meeting_three.endpoint, meeting_one.endpoint] == [
            meeting['id'] for meeting in res.json['data']
        ]
        ...
        res = app.get('{}{}'.format(sort_url, '-start_date'))
        assert len(res.json['data']) == 3
        assert [meeting_one.endpoint, meeting_three.endpoint, meeting_two.endpoint] == [
            meeting['id'] for meeting in res.json['data']
        ]
        ...
        assert len(res.json['data']) == 3
        assert [meeting_two.endpoint, meeting_one.endpoint, meeting_three.endpoint] == [
            meeting['id'] for meeting in res.json['data']
        ]
        ...
        res = app.get('{}{}'.format(sort_url, '-submissions_count'))
        assert len(res.json['data']) == 3
        assert [meeting_three.endpoint, meeting_one.endpoint, meeting_two.endpoint] == [
            meeting['id'] for meeting in res.json['data']
        ]
