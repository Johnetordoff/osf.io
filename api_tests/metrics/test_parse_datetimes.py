...
class TestParseDatetimes:
    ...
    def test_end_date_before_start_date_fails(
        self, mock_timezone, start_date, end_date
    ):
        mock_timezone.return_value = datetime(2019, 1, 4, tzinfo=timezone.utc)
        try:
    ...
    @mock.patch('api.metrics.utils.timezone.now')
    def test_end_date_before_start_on_date_fails(
        self, mock_timezone, start_date, end_date
    ):
        mock_timezone.return_value = datetime(2019, 1, 4, tzinfo=timezone.utc)
        try:
    ...
    @mock.patch('api.metrics.utils.timezone.now')
    def test_time_used_for_specifc_date_fails(
        self, mock_timezone, start_date, end_date
    ):
        mock_timezone.return_value = datetime(2019, 1, 4, tzinfo=timezone.utc)
        try:
    ...
    @mock.patch('api.metrics.utils.timezone.now')
    def test_end_date_but_no_start_date_fails(
        self, mock_timezone, start_date, end_date
    ):
        mock_timezone.return_value = datetime(2019, 1, 4, tzinfo=timezone.utc)
        try:
    ...
    @mock.patch('api.metrics.utils.timezone.now')
    def test_time_in_one_but_not_the_other_fails(
        self, mock_timezone, start_date, end_date
    ):
        mock_timezone.return_value = datetime(2019, 1, 4, tzinfo=timezone.utc)
        try:
