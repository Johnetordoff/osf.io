...
class TestWikiVersionContentView(ApiWikiTestCase):
    def _set_up_public_project_with_wiki_page(self):
        ...
        self.public_url = '/{}wikis/{}/versions/{}/content/'.format(
            API_BASE, self.public_wiki.wiki_page._id, self.public_wiki.identifier
        )
    ...
    def _set_up_private_project_with_wiki_page(self):
        ...
        self.private_url = '/{}wikis/{}/versions/{}/content/'.format(
            API_BASE, self.private_wiki.wiki_page._id, self.private_wiki.identifier
        )
    ...
    def _set_up_public_registration_with_wiki_page(self):
        ...
        self.public_registration_wiki = WikiVersion.objects.get_for_node(
            self.public_registration, 'home'
        )
        self.public_registration.save()
        self.public_registration_url = '/{}wikis/{}/versions/{}/content/'.format(
            API_BASE,
            self.public_registration_wiki.wiki_page._id,
            self.public_registration_wiki.identifier,
        )
    ...
    def test_older_versions_content_can_be_accessed(self):
        ...
        wiki_version = self.private_wiki.wiki_page.update(
            self.user, 'Second draft of wiki'
        )
        ...
        self.private_url_latest = '/{}wikis/{}/versions/{}/content/'.format(
            API_BASE, wiki_page._id, wiki_version.identifier
        )
