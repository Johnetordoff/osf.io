...
class PreprintListMatchesPreprintDetailMixin:
    ...
    def preprint_published(
        self, user_admin_contrib, provider_two, project_published, subject
    ):
    ...
    def test_unpublished_invisible_to_public(
        self, app, preprint_unpublished, preprint_published, list_url, detail_url
    ):
...
class PreprintIsPublishedListMixin:
    ...
    def test_unpublished_invisible_to_non_contribs(
        self, app, user_non_contrib, preprint_unpublished, preprint_published, url
    ):
    ...
    def test_filter_published_false_non_contrib(self, app, user_non_contrib, url):
        res = app.get(
            '{}filter[is_published]=false'.format(url), auth=user_non_contrib.auth
        )
...
class PreprintIsValidListMixin:
    ...
    @pytest.fixture()
    def preprint(
        self, user_admin_contrib, user_write_contrib, project, provider, subject
    ):
