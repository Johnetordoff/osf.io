...
class TestTokenScopes:
    ...
    def test_user_token_scopes(
        self, app, url_token_scopes_list, user_one, user_two, read_scope
    ):
        ...
        url = api_v2_url(
            'tokens/{}/scopes/?version={}'.format(
                'bad_token', SCOPES_RELATIONSHIP_VERSION
            ),
            base_route='/',
        )
