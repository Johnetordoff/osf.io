...
class PageCounter(BaseModel):
    ...
    resource = models.ForeignKey(Guid, related_name='pagecounters', null=False, blank=False, on_delete=models.SET_NULL)
    file = models.ForeignKey('osf.BaseFileNode', null=False, blank=False, related_name='pagecounters', on_delete=models.SET_NULL)
