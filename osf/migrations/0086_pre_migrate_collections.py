...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'guid',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='osf.Guid'
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name='_collection_collected_types_+',
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        through='osf.CollectedGuidMetadata',
                        to='osf.Guid',
                    ),
                ),
                (
        ...
        migrations.AlterOrderWithRespectTo(
            name='collectedguidmetadata', order_with_respect_to='collection',
        ),
        migrations.AlterUniqueTogether(
            name='collectedguidmetadata', unique_together=set([('collection', 'guid')]),
        ),
    ]
