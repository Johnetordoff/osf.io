    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'email_last_sent',
                    osf.utils.fields.NonNaiveDateTimeField(blank=True, null=True),
                ),
                (
                    'emails',
                    django.contrib.postgres.fields.ArrayField(
                ...
                (
                    'osf_mailing_lists',
                    osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(
                        blank=True, default=osf.models.user.get_default_mailing_lists
                    ),
                ),
                (
                    'date_registered',
                ...
                (
                    ...
                    osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(
                        blank=True,
                        default=list,
                        validators=[osf.models.validators.validate_history_item],
                    ),
                ),
                (
                    'schools',
                ...
                (
                    ...
                    osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(
                        blank=True,
                        default=dict,
                        validators=[osf.models.validators.validate_social],
                    ),
                ),
                ...
                (
                    'timezone',
                    models.CharField(blank=True, default='Etc/UTC', max_length=255),
                ),
                (
                    'locale',
                    models.CharField(blank=True, default='en_US', max_length=255),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'title',
                    models.TextField(validators=[osf.models.validators.validate_title]),
                ),
                (
                    'wiki_pages_current',
                    osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(
                ...
                (
                    ...
                    models.NullBooleanField(db_index=True, default=False),
                ),
                (
                    'registered_date',
                    osf.utils.fields.NonNaiveDateTimeField(
            ...
            bases=(
                ...
                osf.models.mixins.CommentableMixin,
                models.Model,
            ),
        ),
        migrations.CreateModel(
            ...
            options={'proxy': True,},
            bases=(LogEntry,),
            managers=[('objects', osf.models.admin_log_entry.AdminLogEntryManager()),],
        ),
        migrations.CreateModel(
            name='AdminProfile',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        default=osf.models.oauth.generate_client_id,
                        max_length=50,
                        unique=True,
                    ),
                ),
                (
                    'client_secret',
                    models.CharField(
                        default=osf.models.oauth.generate_client_secret, max_length=40
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'token_id',
                    models.CharField(
                        default=osf.models.oauth.generate_token_id,
                        max_length=70,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'sent',
                    models.BooleanField(default=False, verbose_name='emails sent'),
                ),
                ('status', models.CharField(default='INITIATED', max_length=40)),
                (
                    'datetime_initiated',
                    osf.utils.fields.NonNaiveDateTimeField(
                        default=django.utils.timezone.now, verbose_name='initiated at'
                    ),
                ),
                (
                    'initiator',
        ...
        migrations.CreateModel(
            ...
            options={'abstract': False, 'ordering': ['_id'],},
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        validators=[
                            osf.models.validators.CommentMaxLength(500),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'oauth_key',
                    osf.utils.fields.EncryptedTextField(blank=True, null=True),
                ),
                (
                    'oauth_secret',
                    osf.utils.fields.EncryptedTextField(blank=True, null=True),
            ...
            fields=[
                ...
                (
                    ...
                    osf.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(
                        ...
                        default=None,
                        null=True,
                        validators=[osf.models.validators.validate_location],
                    ),
                ),
                (
                    'creator',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    osf.utils.fields.LowercaseCharField(
                        db_index=True,
                        default=osf.models.base.generate_guid,
                        max_length=255,
                        unique=True,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        max_length=50,
                        validators=[osf.models.validators.validate_subscription_type],
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name='_notificationsubscription_email_digest_+',
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    'email_transactional',
                    models.ManyToManyField(
                        related_name='_notificationsubscription_email_transactional_+',
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    'none',
                    models.ManyToManyField(
                        related_name='_notificationsubscription_none_+',
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'licenses_acceptable',
                    models.ManyToManyField(blank=True, to='osf.NodeLicense'),
                ),
            ],
            options={'abstract': False,},
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'nodes',
                    models.ManyToManyField(
                        related_name='private_links', to='osf.AbstractNode'
                    ),
                ),
            ],
            options={'abstract': False,},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'parents',
                    models.ManyToManyField(related_name='children', to='osf.Subject'),
                ),
            ],
            options={'abstract': False,},
        ),
        ...
        migrations.AlterUniqueTogether(
            name='tag', unique_together=set([('name', 'system')]),
        ),
        migrations.AlterUniqueTogether(
            name='nodelicense', unique_together=set([('_id', 'license_id')]),
        ),
        migrations.AlterUniqueTogether(
            name='metaschema', unique_together=set([('name', 'schema_version')]),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through='osf.InstitutionalContributor',
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AlterUniqueTogether(
            name='externalaccount', unique_together=set([('provider', 'provider_id')]),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(
                related_name='basefilenode_tagged', to='osf.Tag'
            ),
        ),
        migrations.AddField(
            model_name='basefilenode',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name='nodes', to='osf.AlternativeCitation'
            ),
        ),
        migrations.AddField(
            model_name='abstractnode',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.SET_NULL,
                related_name='registrations',
                to='osf.EmbargoTerminationApproval',
            ),
        ),
        migrations.AddField(
            model_name='abstractnode',
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(
                related_name='abstractnode_tagged', to='osf.Tag'
            ),
        ),
        migrations.AddField(
            model_name='abstractnode',
        ...
        migrations.AddField(
            ...
            name='recently_added',
            field=models.ManyToManyField(
                through='osf.RecentlyAddedContributor', to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            model_name='osfuser',
        ...
        migrations.AlterUniqueTogether(
            name='preprintservice', unique_together=set([('node', 'provider')]),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='noderelation', unique_together=set([('parent', 'child')]),
        ),
        ...
        migrations.AlterOrderWithRespectTo(
            name='noderelation', order_with_respect_to='parent',
        ),
        migrations.AddField(
        ...
        migrations.AlterIndexTogether(
            name='guid', index_together=set([('content_type', 'object_id', 'created')]),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='contributor', unique_together=set([('user', 'node')]),
        ),
        migrations.AlterOrderWithRespectTo(
            name='contributor', order_with_respect_to='node',
        ),
        migrations.AddField(
            model_name='archivejob',
            name='dst_node',
