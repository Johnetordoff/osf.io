    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name='preprints', to='osf.Subject'
            ),
        ),
        migrations.AddField(
            model_name='preprint',
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                default='Untitled', validators=[osf.models.validators.validate_title]
            ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name='preprints',
                through='osf.PreprintContributor',
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AlterUniqueTogether(name='preprint', unique_together=set([]),),
        migrations.AlterUniqueTogether(
            name='preprintcontributor', unique_together=set([('user', 'preprint')]),
        ),
        migrations.AlterOrderWithRespectTo(
            name='preprintcontributor', order_with_respect_to='preprint',
        ),
    ]
