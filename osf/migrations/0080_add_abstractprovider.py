...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'type',
                    models.CharField(
                        choices=[('osf.preprintprovider', 'preprint provider')],
                        db_index=True,
                        max_length=255,
                    ),
                ),
                ...
                (
                    'share_publish_type',
                    models.CharField(
                        choices=[('Preprint', 'Preprint'), ('Thesis', 'Thesis')],
                        default='Preprint',
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name='licenses_acceptable',
                        to='osf.NodeLicense',
                    ),
                ),
            ],
        ...
        migrations.RemoveField(model_name='preprintprovider', name='default_license',),
        migrations.RemoveField(
            model_name='preprintprovider', name='licenses_acceptable',
        ),
        migrations.DeleteModel(name='PreprintProvider',),
        migrations.CreateModel(
