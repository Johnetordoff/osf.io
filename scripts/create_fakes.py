...
def create_fake_project(creator, n_users, privacy, n_components, name, n_tags, presentation_name, is_registration, is_preprint, preprint_provider):
    ...
    if is_preprint:
        ...
        privacy = 'public'
        mock_change_identifier = mock.patch('website.identifiers.clients.ezid_client.EzidClient.change_status_identifier')
        mock_change_identifier.start()
        mock_change_identifier_preprints = mock.patch('website.identifiers.clients.crossref_client.CrossRefClient.change_status_identifier')
