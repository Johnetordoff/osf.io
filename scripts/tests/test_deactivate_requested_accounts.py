...
from osf.management.commands.deactivate_requested_accounts import (
...
class TestDeactivateRequestedAccount:
    ...
    def test_deactivate_user_with_no_content(
        self, mock_mail, user_requested_deactivation
    ):
    ...
    @mock.patch('osf.management.commands.deactivate_requested_accounts.mails.send_mail')
    def test_deactivate_user_with_content(
        self, mock_mail, user_requested_deactivation_with_node
    ):
