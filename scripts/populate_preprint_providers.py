...
def update_or_create(provider_data):
    ...
    provider_data['domain_redirect_enabled'] &= PREPRINT_PROVIDER_DOMAINS[
        'enabled'
    ] and bool(provider_data['domain'])
    licenses = [
        get_license(name) for name in provider_data.pop('licenses_acceptable', [])
    ]
    ...
    if provider:
        provider_data['subjects_acceptable'] = [
            ...
            for rule in provider_data['subjects_acceptable']
        ]
        if licenses:
...
def main(env):
    PREPRINT_PROVIDERS = {
        ...
        'psyarxiv': {
            ...
            'subjects_acceptable': [
                ...
                (
                    ['Social and Behavioral Sciences', 'Psychology', 'Pain Management'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Linguistics', 'Morphology'],
                    False,
                ),
                (
                    [
        ...
        'agrixiv': {
            ...
            'subjects_acceptable': [
                ...
                (
                    [
                        'Business',
                        'Business Law, Public Responsibility, and Ethics Business',
                    ],
                    False,
                ),
                ...
                (
                    ['Engineering', 'Computational Engineering', 'Digital Circuits'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Engineering', 'Computational Engineering', 'Hardware Systems'],
                    False,
                ),
                ...
                (
                    ['Engineering', 'Nanoscience and Nanotechnology', 'Ergonomics'],
                    False,
                ),
                (
                    [
                ...
                (
                    [
                        'Life Sciences',
                        'Animal Sciences',
                        'Aquaculture and Fisheries Life Sciences',
                    ],
                    False,
                ),
                ...
                (
                    ['Life Sciences', 'Animal Sciences', 'Poultry or Avian Science'],
                    False,
                ),
                ...
                (
                    ['Life Sciences', 'Genetics and Genomics', 'Computational Biology'],
                    False,
                ),
                (['Life Sciences', 'Genetics and Genomics', 'Genetics'], False),
                (['Life Sciences', 'Genetics and Genomics', 'Genomics'], False),
                (
                    ['Life Sciences', 'Genetics and Genomics', 'Molecular Genetics'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Life Sciences', 'Immunology and Infectious Disease', 'Immunity'],
                    False,
                ),
                (
                    [
                ...
                (
                    [
                        'Life Sciences',
                        'Laboratory and Basic Science Research Life Sciences',
                        'Bacteriology',
                    ],
                    False,
                ),
                ...
                (
                    [
                        ...
                        'Environmental Health Life Sciences',
                    ],
                    False,
                ),
                (
                ...
                (
                    [
                        'Life Sciences',
                        'Plant Sciences',
                        'Plant Breeding and Genetics Life Sciences',
                    ],
                    False,
                ),
                ...
                (
                    ['Medicine and Health Sciences', 'Systems Biology', 'Diagnosis'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Medicine and Health Sciences', 'Systems Biology', 'Therapeutics'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Medicine and Health Sciences', 'Anatomy', 'Animal Structures'],
                    False,
                ),
                ...
                (
                    ['Medicine and Health Sciences', 'Anatomy', 'Digestive System'],
                    False,
                ),
                (
                    ['Medicine and Health Sciences', 'Anatomy', 'Embryonic Structures'],
                    False,
                ),
                (
                    ['Medicine and Health Sciences', 'Anatomy', 'Endocrine System'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Medicine and Health Sciences', 'Anatomy', 'Integumentary System'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Medicine and Health Sciences', 'Anatomy', 'Respiratory System'],
                    False,
                ),
                ...
                (
                    ['Medicine and Health Sciences', 'Anatomy', 'Urogenital System'],
                    False,
                ),
                ...
                (
                    ['Medicine and Health Sciences', 'Medical Specialties', 'Oncology'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Medicine and Health Sciences', 'Medical Specialties', 'Podiatry'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Medicine and Health Sciences', 'Medical Specialties', 'Surgery'],
                    False,
                ),
                (
                    ['Medicine and Health Sciences', 'Medical Specialties', 'Trauma'],
                    False,
                ),
                (
                    ['Medicine and Health Sciences', 'Medical Specialties', 'Urology'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Medicine and Health Sciences', 'Nanotechnology', 'Nanomedicine'],
                    False,
                ),
                ...
                (
                    ['Medicine and Health Sciences', 'Optometry', 'Mesomycetozoea'],
                    False,
                ),
                ...
                (
                    ['Physical Sciences and Mathematics', 'Earth Sciences', 'Geology'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Physical Sciences and Mathematics', 'Mathematics', 'Algebra'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Physical Sciences and Mathematics', 'Mathematics', 'Analysis'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Physical Sciences and Mathematics', 'Mathematics', 'Set Theory'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Physical Sciences and Mathematics', 'Physics', 'Fluid Dynamics'],
                    False,
                ),
                ...
                (
                    ['Physical Sciences and Mathematics', 'Physics', 'Other Physics'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Animal Studies', 'Folklore'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Communication', 'Publishing'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Communication', 'Social Media'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Econometrics'],
                    False,
                ),
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Economic History'],
                    False,
                ),
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Economic Theory'],
                    False,
                ),
                ...
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Health Economics'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Labor Economics'],
                    False,
                ),
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Macroeconomics'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Public Economics'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Economics', 'Other Economics'],
                    False,
                ),
                ...
                (
                    [
                        'Social and Behavioral Sciences',
                        'Organization Development',
                        'Policy History, Theory, and Methosd',
                    ],
                    False,
                ),
                (
        ...
        'bitss': {
            ...
            'subjects_acceptable': [
                (
                    ['Medicine and Health Sciences', 'Health Information Technology'],
                    False,
                ),
                ...
                (
                    ['Social and Behavioral Sciences', 'Legal Studies', 'Legal Theory'],
                    False,
                ),
                (
                    [
                ...
                (
                    ['Social and Behavioral Sciences', 'Social Statistics', 'Tourism'],
                    False,
                ),
                (
                    [
    ...
    preprint_providers_to_add = (
        STAGING_PREPRINT_PROVIDERS if env == 'stage' else PROD_PREPRINT_PROVIDERS
    )
