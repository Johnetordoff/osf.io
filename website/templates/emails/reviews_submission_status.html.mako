                                ...
                                <table style="display: inline-table;" width="53" border="0" cellspacing="0" cellpadding="0" align="center">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${u'https://www.facebook.com/sharer/sharer.php?u={link}%3Futm_source%3Dnotification%26utm_medium%3Demail%26utm_campaign%3D{word}_review_status'.format(link=reviewable.absolute_url)}" target="_blank">
