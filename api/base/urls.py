    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r'^alerts/',
                    include(('api.alerts.urls', 'alerts'), namespace='alerts'),
                ),
                url(
                    r'^applications/',
                ...
                url(
                    r'^citations/',
                    include('api.citations.urls', namespace='citations'),
                ),
                url(
                    r'^collections/',
                    include('api.collections.urls', namespace='collections'),
                ),
                url(r'^comments/', include('api.comments.urls', namespace='comments')),
                url(
                    r'^docs/',
                    RedirectView.as_view(pattern_name=views.root),
                    name='redirect-to-root',
                    kwargs={'version': default_version},
                ),
                url(
                    r'^draft_nodes/',
                    include('api.draft_nodes.urls', namespace='draft_nodes'),
                ),
                url(
                    r'^draft_registrations/',
                    include(
                        'api.draft_registrations.urls', namespace='draft_registrations',
                    ),
                ),
                ...
                url(
                    r'^identifiers/',
                    include('api.identifiers.urls', namespace='identifiers'),
                ),
                url(
                    r'^institutions/',
                    include('api.institutions.urls', namespace='institutions'),
                ),
                url(r'^licenses/', include('api.licenses.urls', namespace='licenses')),
                url(r'^logs/', include('api.logs.urls', namespace='logs')),
                url(
                    r'^metaschemas/',
                    include('api.metaschemas.urls', namespace='metaschemas'),
                ),
                url(r'^schemas/', include('api.schemas.urls', namespace='schemas')),
                url(r'^nodes/', include('api.nodes.urls', namespace='nodes')),
                url(
                    r'^preprints/',
                    include('api.preprints.urls', namespace='preprints'),
                ),
                url(
                    r'^preprint_providers/',
                    include(
                        'api.preprint_providers.urls', namespace='preprint_providers',
                    ),
                ),
                url(r'^regions/', include('api.regions.urls', namespace='regions')),
                url(
                    r'^providers/',
                    include('api.providers.urls', namespace='providers'),
                ),
                url(
                    r'^registrations/',
                ...
                url(
                    r'^requests/',
                    include(('api.requests.urls', 'requests'), namespace='requests'),
                ),
                ...
                url(
                    r'^subscriptions/',
                    include('api.subscriptions.urls', namespace='subscriptions'),
                ),
                url(
                    r'^taxonomies/',
                    include('api.taxonomies.urls', namespace='taxonomies'),
                ),
                ...
                url(
                    r'^view_only_links/',
                    include('api.view_only_links.urls', namespace='view-only-links'),
                ),
                url(r'^wikis/', include('api.wikis.urls', namespace='wikis')),
                url(
                    r'^_waffle/',
                    include(('api.waffle.urls', 'waffle'), namespace='waffle'),
                ),
            ],
        ),
    ),
