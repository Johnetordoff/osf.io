...
urlpatterns = [
    ...
    url(
        ...
        name=views.GroupDetail.view_name,
    ),
    url(
        r'^(?P<group_id>\w+)/members/$',
        views.GroupMembersList.as_view(),
        name=views.GroupMembersList.view_name,
    ),
    url(
        r'^(?P<group_id>\w+)/members/(?P<user_id>\w+)/$',
