...
urlpatterns = [
    ...
    url(
        r'^components/$',
        views.SearchComponents.as_view(),
        name=views.SearchComponents.view_name,
    ),
    url(r'^files/$', views.SearchFiles.as_view(), name=views.SearchFiles.view_name),
    url(
        r'^projects/$',
        views.SearchProjects.as_view(),
        name=views.SearchProjects.view_name,
    ),
    url(
        r'^registrations/$',
        views.SearchRegistrations.as_view(),
        name=views.SearchRegistrations.view_name,
    ),
    url(r'^users/$', views.SearchUsers.as_view(), name=views.SearchUsers.view_name),
    url(
        r'^institutions/$',
        views.SearchInstitutions.as_view(),
        name=views.SearchInstitutions.view_name,
    ),
    url(
        r'^collections/$',
        views.SearchCollections.as_view(),
        name=views.SearchCollections.view_name,
    ),
